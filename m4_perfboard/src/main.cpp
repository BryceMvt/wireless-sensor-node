...
{
  // Enable the thermistor source voltage
  ...
  // Disable the thermistor source voltage
  digitalWrite(thermistor_source_pin, LOW);

  // Convert the raw 10-bit reading value to a meaningful voltage
...
void setup()
{
  ...
  // Thermistor voltage source enable pin
